...
st.write('The Random Forest Classifier proves to be a robust tool in fetal health prediction,\
harnessing a diverse range of features to make accurate assessments.' 
'n\The confusion matrix below provides a comprehensive overview of classification results,' \
'nwhile the classification report offers insightful precision, recall, and F1-score statistics for each class.')
