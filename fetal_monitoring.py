...
The Suspect class had lower precision and recall (0.81 and 0.78), suggesting some difficulty in correctly identifying Suspect cases. \
However, the model performed well in identifying Pathological cases, with a precision of 0.80 and high recall of 0.97. \
Overall, the model achieved an accuracy of 93%, with a balanced macro average F1-score of 0.88 across all classes.")
